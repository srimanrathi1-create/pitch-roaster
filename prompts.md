# Pitch Roaster — Prompts v3

This file contains the framework prompt and all persona prompts used by the Prepitch app. The framework prompt defines WHAT to evaluate. Persona prompts define HOW to deliver the verdict — voice, tone, joke style, references.

## Framework Prompt (always included)
